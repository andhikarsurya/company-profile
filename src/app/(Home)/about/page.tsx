...
export default function About(){
    return(
        <div>
            <div className="flex w-full justify-center items-center bg-slate-700">
                <div className="flex flex-col justify-center items-start text-justify text-yellow-200 w-[90%]">
                    <div className="text-[2rem] mt-[7rem]">
                        History <hr className="w-[200%] h-[3px] my-[1rem] bg-yellow-200"/>
                    </div>
                    <div>
                    <p>
                    ...
                    <p className="my-[1rem] ml-[1rem] mb-[3rem]">
